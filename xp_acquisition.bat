...
echo [*] Copying IE Temporary Internet Files...
xcopy /E /I /H /Y "%USERPROFILE%\Local Settings\Temporary Internet Files" "%outdir%\IE_Temporary_Internet_Files" >nul 2>&1

echo [*] Copying IE History files...
xcopy /E /I /H /Y "%USERPROFILE%\Local Settings\History" "%outdir%\IE_History" >nul 2>&1
